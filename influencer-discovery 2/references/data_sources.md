...
报价为行业基准近似值，来源：influencerfee.com、SocialBlade 估算、品牌方实际成交参考。
实际报价受季节性、排期、内容复杂度、独家性等影响波动较大，仅供参考。
...
| mega 2M+ | $20,000–$100,000 | $50,000–$200,000 |

TikTok Shop 分销多为 8–15% 佣金制（无固定费用，按成交抽佣）。

### YouTube 报价基准

| 区间 | standard 植入 | dedicated 专属视频 |
|------|--------------|-------------------|
| nano 1K–10K | $0–$200 | $100–$500 |
| micro 10K–100K | $200–$2,000 | $600–$4,000 |
| mid 100K–500K | $1,500–$8,000 | $4,000–$18,000 |
| macro 500K–2M | $6,000–$30,000 | $12,000–$60,000 |
| mega 2M+ | $15,000–$80,000 | $40,000–$150,000 |

YouTube 长视频制作成本高，dedicated 报价通常含制作费。Shorts 报价约为长视频的 50–70%。

### 垂类溢价/折扣

脚本 `build_shortlist.py` 自动按 niche 关键词应用以下修正：

| 垂类 | 修正系数 | 说明 |
|------|---------|------|
| 美妆/护肤/时尚/理财/健身/健康/奢侈品/旅游 | ×1.2 | 高商业转化，品牌竞争激烈 |
| 科技/游戏/教育/科学/政治 | ×0.7 | B2B 或低冲动消费，CPM 偏低 |
| 其他（美食/搞笑/生活方式等） | ×1.0 | 基准不调整 |

> 以上系数为近似值，实际因品牌而异。脚本中 `HIGH_VALUE_NICHES` 和 `LOW_VALUE_NICHES` 可手动扩展。
